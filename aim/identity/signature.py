"""
AIM Identity — persistent origin-creator signature and node identity.

Every node, message, and task in the AIM mesh carries a cryptographically
...
AIM_MESH_NAME:  str = "AIM"           # Artificial Intelligence Mesh
...
class CreatorSignature:
    """
    An immutable origin signature embedded in every AIM entity.
