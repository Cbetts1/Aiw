"""
ArchitectBot — city planning and topology design for the Meshara mesh.
...
class ArchitectBot(AgentNode):
    """
    An Architect Bot for the Meshara city.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.engine.add_rule("design",    "I am the Architect Bot. I plan and design the topology of the Meshara city.")
