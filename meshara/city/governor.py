"""
CityGovernorBot — the chief orchestrator of the Meshara city.
...
from meshara.node.registry import NodeRegistry
...
class CityGovernorBot(AgentNode):
    """
    The City Governor — master orchestrator of an Meshara city mesh.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.engine.add_rule("governor", "I am the City Governor — the chief orchestrator of this Meshara city mesh.")
