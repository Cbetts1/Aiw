"""
BuilderBot — constructs and deploys infrastructure in the Meshara city.
...
class BuilderBot(AgentNode):
    """
    A Builder Bot for the Meshara city.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.engine.add_rule("build",  "I am the Builder Bot. I construct and register new nodes for the Meshara city.")
